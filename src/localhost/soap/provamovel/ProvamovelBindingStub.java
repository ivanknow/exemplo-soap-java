...
public class ProvamovelBindingStub extends org.apache.axis.client.Stub implements localhost.soap.provamovel.ProvamovelPortType {
    ...
    public ProvamovelBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ProvamovelBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ProvamovelBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public java.lang.String login(java.lang.String email, java.lang.String senha) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://localhost/workspace/provamovel-web-client/server/serversoap/server.php/login");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:provamovel", "login"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {email, senha});
  ...
  throw axisFaultException;
    ...
    public java.lang.String cadastrar(java.lang.String email, java.lang.String senha, java.lang.String cep) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://localhost/workspace/provamovel-web-client/server/serversoap/server.php/cadastrar");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:provamovel", "cadastrar"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {email, senha, cep});
