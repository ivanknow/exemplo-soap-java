...
public class DadoServiceLocator extends org.apache.axis.client.Service implements localhost.axis.Dado_jws.DadoService {
    ...
    private java.lang.String Dado_address = "http://localhost:8080/axis/Dado.jws";
    ...
    public localhost.axis.Dado_jws.Dado getDado(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            localhost.axis.Dado_jws.DadoSoapBindingStub _stub = new localhost.axis.Dado_jws.DadoSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (localhost.axis.Dado_jws.Dado.class.isAssignableFrom(serviceEndpointInterface)) {
                localhost.axis.Dado_jws.DadoSoapBindingStub _stub = new localhost.axis.Dado_jws.DadoSoapBindingStub(new java.net.URL(Dado_address), this);
                _stub.setPortName(getDadoWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8080/axis/Dado.jws", "DadoService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8080/axis/Dado.jws", "Dado"));
        }
